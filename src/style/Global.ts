...
import MontserratExtraBold from '../assets/fonts/Montserrat/Montserrat-ExtraBold.woff';
import Montserrat from '../assets/fonts/Montserrat/Montserrat-Regular.woff';
